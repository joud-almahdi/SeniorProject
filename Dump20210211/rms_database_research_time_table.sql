...
CREATE TABLE `research_time_table` (
  ...
  `Research_startime` datetime(6) DEFAULT NULL,
  `Research_endtime` datetime(6) DEFAULT NULL,
  `Research_netime` int DEFAULT NULL,
  KEY `foreign_key_rid` (`Research_id`),
  CONSTRAINT `foreign_key_rid` FOREIGN KEY (`Research_id`) REFERENCES `researches_table` (`research_id`)
